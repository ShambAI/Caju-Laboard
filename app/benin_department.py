...
class Benin_dept_LAYER:
    def __init__(self, benin_dept_layer):
        self.benin_dept_layer = benin_dept_layer
    ...
    def add_benin_department(self):
        ...
        for feature in temp_geojson.data['features']:
            ...
            self.dept_yieldHa[name] = yield_haD
            ...
            temp_layer1.add_to(self.benin_dept_layer)

        return self.benin_dept_layer, self.dept_yieldHa
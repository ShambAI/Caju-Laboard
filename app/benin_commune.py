...
class Benin_commune_LAYER:
    def __init__(self, benin_commune_layer):
        self.benin_commune_layer = benin_commune_layer
    ...
    def add_benin_commune(self):
        ...
        for feature in temp_geojson2.data['features']:
            ...
            temp_layer2.add_to(self.benin_commune_layer)
        return self.benin_commune_layer